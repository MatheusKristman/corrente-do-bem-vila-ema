...
export function About() {
  return (
    <section className="w-full px-6 pt-24 sm:px-16 sm:pt-36 lg:container lg:mx-auto">
      <Element name="about" className="w-full flex flex-col gap-16 lg:flex-row">
        ...
        <div className="w-full flex flex-col gap-12">
          <div className="w-full flex flex-col gap-9">
            ...
            <div className="w-full flex flex-col gap-5">
              ...
              <p className="text-base text-foreground/70 lg:text-xl">
                Ao longo do tempo, a Corrente do Bem expandiu sua atuação e consolidou projetos que fortalecem sua
                missão de transformar vidas. Entre nossas iniciativas, destacam-se:
              </p>
            </div>
